...
my_list.insert(1, 50)
print(my_list) #[1, 50, 2, 3]
#insert an element at index -1 and print
my_list = [1, 2, 3]
my_list.insert(-1, 50)
print(my_list) #[1, 2, 50, 3]
#insert an element at index 10000 and print
my_list = [1, 2, 3]
my_list.insert(10000, 50)
print(my_list) #[1, 2, 3, 50]
#insert an element at index -10000 and print
my_list = [1, 2, 3]
my_list.insert(-10000, 50)
print(my_list) #[50, 1, 2, 3]
